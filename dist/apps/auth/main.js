...
const roles_repository_1 = __webpack_require__(/*! ../../../libs/common/src/dbhelper/roles.repository */ "./libs/common/src/dbhelper/roles.repository.ts");
const lodash_1 = __webpack_require__(/*! lodash */ "lodash");
const users_repository_1 = __webpack_require__(/*! ../../../libs/common/src/dbhelper/users.repository */ "./libs/common/src/dbhelper/users.repository.ts");
const login_dto_1 = __webpack_require__(/*! @app/common/dto/auth/login.dto */ "./libs/common/src/dto/auth/login.dto.ts");
let AuthController = class AuthController {
    constructor(authService, rolesRepository, usersRepository) {
        this.authService = authService;
        this.rolesRepository = rolesRepository;
        this.usersRepository = usersRepository;
    }
    async login(body, user, response) {
    ...
    async authenticate(data) {
        var _a;
        let user = data.user;
        const roles = await this.rolesRepository.find({ _id: { $in: user.roles }, status: 'active' }, { select: Object.assign({}, common_1.RolesProjection) });
        const rolesMap = (0, lodash_1.keyBy)(roles, '_id');
        user.roles = (_a = user === null || user === void 0 ? void 0 : user.roles) === null || _a === void 0 ? void 0 : _a.map(role => rolesMap[role]);
        return data.user;
    }
    async users(data) {
        const targetUsers = await this.usersRepository.find({
            _id: { $in: data === null || data === void 0 ? void 0 : data._ids },
            "meta.orgInfo.code": data === null || data === void 0 ? void 0 : data.code,
            status: common_1.UserStatus.active
        }, { select: Object.assign({}, common_1.UserProjection) });
        return targetUsers || [];
    }
};
__decorate([
    ...
    __param(2, (0, common_2.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_d = typeof login_dto_1.LoginDto !== "undefined" && login_dto_1.LoginDto) === "function" ? _d : Object, typeof (_e = typeof common_1.User !== "undefined" && common_1.User) === "function" ? _e : Object, typeof (_f = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _f : Object]),
...
__decorate([
    (0, microservices_1.MessagePattern)('users'),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
AuthController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof auth_service_1.AuthService !== "undefined" && auth_service_1.AuthService) === "function" ? _a : Object, typeof (_b = typeof roles_repository_1.RolesRepository !== "undefined" && roles_repository_1.RolesRepository) === "function" ? _b : Object, typeof (_c = typeof users_repository_1.UsersRepository !== "undefined" && users_repository_1.UsersRepository) === "function" ? _c : Object])
], AuthController);
...
const roles_module_1 = __webpack_require__(/*! ./roles/roles.module */ "./apps/auth/src/roles/roles.module.ts");
...
let AuthService = class AuthService {
    ...
    async login(user, response) {
        ...
        const tokenPayload = {
            ...
            orgInfo: (_a = user === null || user === void 0 ? void 0 : user.meta) === null || _a === void 0 ? void 0 : _a.orgInfo,
            workspaces: (user === null || user === void 0 ? void 0 : user.workspaces) || [],
        };
...
/***/ "./apps/auth/src/roles/roles.module.ts":
/*!*********************************************!*\
  !*** ./apps/auth/src/roles/roles.module.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const dbhelper_1 = __webpack_require__(/*! @app/common/dbhelper */ "./libs/common/src/dbhelper/index.ts");
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const roles_service_1 = __webpack_require__(/*! ./roles.service */ "./apps/auth/src/roles/roles.service.ts");
...
/***/ "./apps/auth/src/roles/roles.service.ts":
/*!**********************************************!*\
  !*** ./apps/auth/src/roles/roles.service.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const Base_factory_1 = __webpack_require__(/*! @app/common/base/Base.factory */ "./libs/common/src/base/Base.factory.ts");
const dbhelper_1 = __webpack_require__(/*! @app/common/dbhelper */ "./libs/common/src/dbhelper/index.ts");
let RolesService = class RolesService extends Base_factory_1.BaseFactory {
...
RolesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof dbhelper_1.RolesRepository !== "undefined" && dbhelper_1.RolesRepository) === "function" ? _a : Object])
], RolesService);
            ...
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([
                (request) => {
                    ...
                    return ((_a = request === null || request === void 0 ? void 0 : request.cookies) === null || _a === void 0 ? void 0 : _a.Authentication) ||
                        (request === null || request === void 0 ? void 0 : request.Authentication) ||
                        (request === null || request === void 0 ? void 0 : request.headers.Authentication);
                },
            ]),
