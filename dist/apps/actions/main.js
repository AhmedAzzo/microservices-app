...
/***/ "./apps/actions/src/actions.controller.ts":
/*!************************************************!*\
  !*** ./apps/actions/src/actions.controller.ts ***!
  \************************************************/
...
const actions_service_1 = __webpack_require__(/*! ./actions.service */ "./apps/actions/src/actions.service.ts");
let ActionsController = class ActionsController {
    constructor(actionsService, rmqService) {
        this.actionsService = actionsService;
        this.rmqService = rmqService;
    }
    async test(data, context) {
        console.log('hello recieving actions', data);
        this.rmqService.ack(context);
    }
    async AddOrder(data, context) {
    }
};
__decorate([
    (0, microservices_1.EventPattern)('actionsClient'),
...
], ActionsController.prototype, "test", null);
__decorate([
    (0, microservices_1.EventPattern)('add_order'),
    __param(0, (0, microservices_1.Payload)()),
    __param(1, (0, microservices_1.Ctx)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], ActionsController.prototype, "AddOrder", null);
ActionsController = __decorate([
    (0, common_2.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof actions_service_1.ActionsService !== "undefined" && actions_service_1.ActionsService) === "function" ? _a : Object, typeof (_b = typeof common_1.RmqService !== "undefined" && common_1.RmqService) === "function" ? _b : Object])
], ActionsController);
...
/***/ "./apps/actions/src/actions.module.ts":
/*!********************************************!*\
  !*** ./apps/actions/src/actions.module.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const actions_controller_1 = __webpack_require__(/*! ./actions.controller */ "./apps/actions/src/actions.controller.ts");
const actions_service_1 = __webpack_require__(/*! ./actions.service */ "./apps/actions/src/actions.service.ts");
...
const workflow_service_1 = __webpack_require__(/*! ./workflow.service */ "./apps/actions/src/workflow.service.ts");
...
ActionsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [actions_service_1.ActionsService, workflow_service_1.WorkflowService],
    })
], ActionsModule);
...
/***/ "./apps/actions/src/actions.service.ts":
/*!*********************************************!*\
  !*** ./apps/actions/src/actions.service.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const dbhelper_1 = __webpack_require__(/*! @app/common/dbhelper */ "./libs/common/src/dbhelper/index.ts");
let ActionsService = class ActionsService extends Base_factory_1.BaseFactory {
    constructor(workflowRepository, actionsRepository) {
...
ActionsService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof dbhelper_1.WorkflowRepository !== "undefined" && dbhelper_1.WorkflowRepository) === "function" ? _a : Object, typeof (_b = typeof dbhelper_1.ActionsRepository !== "undefined" && dbhelper_1.ActionsRepository) === "function" ? _b : Object])
], ActionsService);
...
/***/ "./apps/actions/src/workflow.service.ts":
/*!**********************************************!*\
  !*** ./apps/actions/src/workflow.service.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const Base_factory_1 = __webpack_require__(/*! @app/common/base/Base.factory */ "./libs/common/src/base/Base.factory.ts");
const dbhelper_1 = __webpack_require__(/*! @app/common/dbhelper */ "./libs/common/src/dbhelper/index.ts");
let WorkflowService = class WorkflowService extends Base_factory_1.BaseFactory {
    constructor(workflowRepository, actionsRepository) {
...
const actions_module_1 = __webpack_require__(/*! ./actions.module */ "./apps/actions/src/actions.module.ts");
const nestjs_pino_1 = __webpack_require__(/*! nestjs-pino */ "nestjs-pino");
const common_2 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
async function bootstrap() {
    const app = await core_1.NestFactory.create(actions_module_1.ActionsModule);
    ...
    common_2.Logger.log(`Actions Microservice is up an running`);
}
bootstrap();
