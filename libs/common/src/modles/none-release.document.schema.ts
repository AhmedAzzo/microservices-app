...
export class NoneRelease extends AbstractDocument implements INoneReleaseDocument {
    @Prop({
        type: String,
        unique: true,
        required: true,
...
export const NoneReleaseSchema = SchemaFactory.createForClass(NoneRelease);
